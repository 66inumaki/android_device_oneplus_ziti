...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="CPH2569-user 15 AP3A.240617.008 T.R4T2.1e3a2ac-3e2a_1a86f release-keys" \
    BuildFingerprint=OnePlus/CPH2569/OP5953L1:15/AP3A.240617.008/T.R4T2.1e3a2ac-3e2a_1a86f:user/release-keys \
    DeviceName=OP5953L1 \
